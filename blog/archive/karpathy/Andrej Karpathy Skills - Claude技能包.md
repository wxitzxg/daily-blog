...
source: "https://mp.weixin.qq.com/s/RB5h5BQ-x3c78JgbjxKBtA?poc_token=HIns5WmjdQfEjQLgDG0KtikQFHJiJEV2EW553Q5O"
author:
  - "[[结构派AI]]"
published:
created: 2026-04-20
...
category: karpathy
tags: [karpathy, claude-skills, ai编程, 编码规范, 工程实践]
summary: 介绍andrej-karpathy-skills项目，一个基于Karpathy对AI编程问题观察而创建的CLAUDE.md文件。项目包含四个核心原则：编码前先思考、简单优先、外科手术式修改、目标驱动执行。实践证明，使用这套规则后，Claude写代码变得更加克制、精准，从"热情过度的实习生"变成"手稳不越界的资深工程师"。
---
结构派AI *2026年4月9日 20:00*
