...
source: "https://mp.weixin.qq.com/s/if-xOoCFuSdsGGYNPmLuRw"
author:
  - "[[微信公众平台]]"
published:
created: 2026-03-25
description:
category: tips
tags: [最佳实践, 配置技巧, context管理, CLAUDE.md, hooks]
summary: 翻译整理的 40 个 Claude Code 最佳实践技巧，涵盖配置设置（cc 别名、statusline、context 扩展）、工作流效率（Esc 回退、Ctrl+B 后台、语音输入）、context 管理（/clear、Plan Mode、ultrathink）、自动化工具（LSP、MCP、Hooks）、进阶技巧（worktrees、subagent、sandbox）。
*2026年3月24日 18:00*
