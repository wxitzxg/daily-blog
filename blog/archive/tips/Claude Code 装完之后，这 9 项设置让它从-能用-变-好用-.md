...
source: "https://mp.weixin.qq.com/s/pKCEOnDvrK8bK2a93TaPOA"
author:
  - "[[街边看漫画]]"
published:
created: 2026-03-25
description: "装好 Claude Code 后别急着用，先花 15 分钟搞定这 9 项设置：输出风格、状态栏、声音提示、记忆系统、终端配置、多代理协作、模型升级、技能扩展，让它从能用变好用。"
category: tips
tags: [设置优化, 配置指南, 用户体验, 输出风格, 记忆系统]
summary: 装好 Claude Code 后必做的 9 项设置：输出风格调整、状态栏安装、声音提示、记忆系统配置、终端优化、多代理协作开启、模型升级、技能扩展等。
---
