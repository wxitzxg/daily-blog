...
published:
created: 2026-03-24
description: "这不是零散技巧合集，而是一份讲清 Claude Code 工作流分工的实战指南：command、skill、agent、settings、memory、MCP 该放什么、怎么配合。"
category: workflow
tags:
  - claude-code
  - 工作流
  ...
  - 分工设计
  - 流程组织
summary: Claude Code 工作流分工指南：command 做入口触发、skill 沉淀可复用方法、agent 处理重任务、settings 放稳定规则、memory 存长期记忆、MCP 接外部能力。解决上下文混乱、职责混乱、流程失控三大痛点。
---
