...
source: "https://mp.weixin.qq.com/s/iTLZQHw9Dkt6AsDumZZJNQ"
author:
  - "[[猕猴桃]]"
published:
created: 2026-03-26
description: "别再等下一代模型了。Anthropic、OpenAI、Stripe都在说：真正值钱的能力在模型外面。"
category: workflow
tags: [harness, anthropic, 工程实践, ai编程, 效率提升]
summary: Harness Engineering深度解析。三代演进：Prompt Engineering（2022-2024写好指令）→ Context Engineering（2025构建上下文）→ Harness Engineering（2026搭建工作环境）。核心案例：同一模型换Harness成功率从42%到78%、OpenAI Codex团队5个月100万行代码全由Agent生成、Stripe Minions每周1300个无人值守PR。关键洞察：模型不会评价自己的工作，需要独立的evaluator Agent；约束解空间反而让Agent更有生产力；Harness是持续演化系统，每代模型都需重新审视。
---
