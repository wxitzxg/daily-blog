...
category: workflow
tags: [ppt工作流, 分阶段交付, agent, 约束流程]
keywords: [ppt工作流, 分阶段交付, agent, 约束流程]
summary: 介绍ppt-agent-workflow-san开源项目，将PPT制作拆成10个阶段：需求澄清→调研→资料整理→调研简报→大纲→策划稿→中间产物→审阅门控→全面展开→复核交付。核心原则是"约束工作流，不约束实现"，适合重要PPT的精心打磨。
---
