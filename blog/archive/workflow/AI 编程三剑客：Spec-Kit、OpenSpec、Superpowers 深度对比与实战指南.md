...
source: "https://mp.weixin.qq.com/s/NeBSi-Q8zUWlWb0mL5BPOA"
author:
  - "[[ElioYue]]"
published:
created: 2026-04-02
description:
category: workflow
tags: [spec-kit, openspec, superpowers, 工作流对比, 实战指南]
summary: 深度对比三款AI编程工作流工具的完整实战指南。Spec-Kit（GitHub官方，69k Star）：规范可执行化，分阶段流程，适合新项目企业级。OpenSpec（Fission-AI，23.7k Star）：轻量规范层，OPSX工作流，适合存量项目快速迭代。Superpowers（obra，50k Star）：技能驱动方法论，TDD强制，专注执行质量。关键结论：Spec-Kit和OpenSpec二选一（功能重叠），再搭配Superpowers互补。
---
