...
source: "https://mp.weixin.qq.com/s/poeBDCvwxyBN9_xa6oTGaA"
author:
  - "[[ColaAI]]"
published:
created: 2026-03-24
description: "👆 点击关注，每周获取最新技术趋势practice made claude perfect15K ⭐"
category: workflow
tags: [claude-code-best-practice, 最佳实践, 架构设计, context管理]
summary: 解读 GitHub 15K Star 的 claude-code-best-practice 仓库，提炼核心经验：Command → Agent → Skill 三层架构、CLAUDE.md 写作原则（控制在 200 行内）、Sub-Agent 卸载耗上下文任务、上下文管理（50% 时 /compact）、规划先行、Hooks 自动质量检查。核心理念：practice made claude perfect。
