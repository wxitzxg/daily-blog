...
description:
category: workflow
tags: [spec-kit, openspec, superpowers, 技术选型, 工作流对比]
summary: 三款AI编程工作流工具的技术选型对比。Spec-Kit（GitHub官方，82.5k Star）：阶段门控式工作流，规范可执行化，适合大型企业项目。OpenSpec（Fission-AI，34.5k Star）：流畅迭代式工作流，轻量规范层，适合快速迭代Brownfield改造。Superpowers（115k Star）：技能触发式工作流，强制TDD，适合质量优先场景。提供技术选型决策树和最佳实践组合建议。
---
