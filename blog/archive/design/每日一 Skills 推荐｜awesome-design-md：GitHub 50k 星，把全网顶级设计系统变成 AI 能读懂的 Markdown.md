...
category: design
tags: [design-md, 设计系统, google-stitch, ai设计]
keywords: [design-md, 设计系统, google-stitch, ai设计]
summary: 介绍GitHub 50k星的开源仓库awesome-design-md，将全网60+知名网站的设计系统转化为AI可读的DESIGN.md格式。每个文件包含视觉主题、色彩系统、排版规则、组件样式等九个章节，让AI Agent生成一致的UI代码。
---
