...
source: "https://mp.weixin.qq.com/s/7kZP1oBgy1esGzNXsRjiGg"
author:
  - "[[运维有术]]"
published:
created: 2026-04-04
...
tags:
  ...
  - 文件系统
  - Manus
summary: 给 Claude Code 装上"硬盘记忆"的插件，用三个 Markdown 文件（task_plan.md、findings.md、progress.md）和四个钩子机制解决 AI 健忘、目标漂移、错误重复等问题。借鉴 Manus AI 的核心工作流模式，支持跨会话保留上下文。
---
