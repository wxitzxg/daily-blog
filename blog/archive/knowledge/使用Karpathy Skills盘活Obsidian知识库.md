...
description:
category: knowledge
tags: [obsidian, 知识管理, llm-wiki, 自动化, skill]
summary: 基于Karpathy的LLM-Wiki思路，作者实现了AI自动维护Obsidian知识库的方案。三层架构：raw/原始材料只进不改、wiki/编译后知识AI维护、tools/CLI工具集。三个核心命令：wiki-update（更新知识）、wiki-query（搜索问答）、wiki-dashboard（查看全貌）。解决知识库维护成本高的问题，让AI负责"整理"环节。
---
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/zTBLgCayWtfZduch7ZOL1tUAiakpRwl61YkPo2mDN4BVpicqProxfzF1n1PL1OclKt6Su8Y5PQUlv1TRbsvibVYFbyeDWTZH3CV8XZ7AIAO8YQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=0)
