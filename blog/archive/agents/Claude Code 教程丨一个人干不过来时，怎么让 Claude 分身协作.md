...
source: "https://mp.weixin.qq.com/s/-sUNH9rXmPsYRxXnZeekjg"
author:
  - "[[凌小添]]"
published:
created: 2026-04-02
description:
category: agents
tags: [subagent, agent-teams, 多智能体, 并行协作, 独立上下文]
summary: 详解 Claude Code 的 Subagent 和 Agent Team 两种多智能体协作方式：Subagent 用于隔离探索保持主对话干净，Agent Team 用于并行协作和互相讨论。
---
