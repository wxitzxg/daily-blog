...
source: "https://mp.weixin.qq.com/s/xjCf73xo-Fz9yk7_EL9qzQ"
author:
  - "[[范志东]]"
published:
created: 2026-04-04
...
tags:
  ...
  - pair-pipeline
  - lance-db
summary: OpenSwarm 是 Claude Code 生态的首个多 Agent 编排器，采用 Worker/Reviewer 配对管道模式，结合 LanceDB 认知记忆系统，实现"一个人的 AI 开发军团"。核心创新：StuckDetector 防止无限循环、Pipeline Guards 自动质量门禁、Per-Role 模型配置实现成本优化。
---
