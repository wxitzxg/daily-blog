...
source: "https://mp.weixin.qq.com/s/4nknz1XOAFTZ1WIuCV4h2A"
author:
  - "[[HelloDong]]"
published:
created: 2026-04-04
description: "实战：用 Claude Code Agent Teams 做大规模代码重构，一个人顶一个团队"
category: agents
tags: [agent-teams, 代码重构, 并行开发, worktree]
summary: 详细讲解 Claude Code Agent Teams 的实战应用，以 Express 到 Hono 框架迁移为例。介绍 TeamCreate、Task、TaskCreate 等核心工具，强调文件所有权、Wave 机制、Plan Mode 先行等黄金法则。3 个 agent 并行 30-45 分钟可完成手动需要 1-2 周的框架迁移工作。
