...
source: "https://mp.weixin.qq.com/s/H8Yi6BztAdCQEhEYHcrg0Q"
author:
  - "[[DracoVibeCoding]]"
published:
created: 2026-03-24
description: "Claude Code又放了个大招：Agent Teams，可以理解成Sub Agents的超级加强版～"
category: agents
tags: [agent-teams, 多智能体协作, 并行工作, teammates, 实验性功能]
summary: Agent Teams 是 Subagents 的超级加强版，多个 teammate 有独立上下文并行跑，之间可以直接互相通信。开启环境变量 CLAUDE_CODE_EXPERIMENTAL_AGENT_TEAMS=1 即可使用。
---
