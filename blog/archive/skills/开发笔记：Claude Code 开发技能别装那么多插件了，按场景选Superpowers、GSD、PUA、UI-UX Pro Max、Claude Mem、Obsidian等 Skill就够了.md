...
category: skills
tags: [superpowers, GSD, PUA, ui-ux-pro-max, claude-mem, obsidian]
summary: 作者分享使用 Claude Code 半年后的 Skill 选择经验，按五大场景推荐：日常开发用 Superpowers + GSD，AI 摆烂用 PUA，前端设计用 UI/UX Pro Max，长期项目用 Claude Mem + Obsidian，资源导航用 Awesome Claude Code。强调精选比贪多更重要。
