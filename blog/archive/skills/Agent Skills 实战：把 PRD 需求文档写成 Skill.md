...
source: "https://mp.weixin.qq.com/s/IvaaVh_li9ysvghSjUjnhQ"
author:
  - "[[进击的肖恩]]"
published:
created: 2026-04-02
description: "Agent Skills实战系列。"
category: skills
tags: [agent-skills, prd, 需求文档, 团队规范, 实战教程]
summary: Agent Skills实战系列文章，以PRD需求文档为例讲解如何将团队规范写成Skill。完整内容：从团队PRD规范定义必填节（背景与问题、目标与成功指标、用户与场景、功能需求、范围与边界、验收标准）、SKILL.md结构示例（执行前、文档结构、需求书写规范、输出格式）、可选reference.md（完整模板、用户故事规范、优先级定义）、可选scripts（检查必选节的bash脚本）、触发方式与团队协作。核心思路：把团队规范清单化→SKILL→reference→触发与协作。
---
