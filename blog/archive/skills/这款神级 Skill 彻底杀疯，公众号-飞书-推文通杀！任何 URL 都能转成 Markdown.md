...
source: "https://mp.weixin.qq.com/s/ndhE-SyX4qdmOODwRc_uJg"
author:
  - "[[easypay007]]"
published:
created: 2026-04-02
description: "markdown-proxy 是一款强大的 AI 抓取 Skill，专治各种网页防爬和格式混乱。它通过路由分发和多层降级策略，能一键将微信公众号、飞书文档、Twitter 推文等任意 URL 提取为干净的 Markdown 数据，是构建高质 AI 知识库的必备神器。"
category: skills
tags: [markdown-proxy, 网页抓取, 飞书api, 公众号]
keywords: [markdown-proxy, 网页抓取, 飞书api, 公众号]
summary: 介绍markdown-proxy skill，通过路由分发和多层降级策略，能一键将微信公众号（Playwright无头浏览器）、飞书文档（开放API直连）、Twitter推文等任意URL提取为干净的Markdown数据。四大抓取通道确保高可用性，是构建AI知识库的必备神器。
---
