...
source: "https://mp.weixin.qq.com/s/JKkdMqnHQUnpt0UYRsLTTA"
author:
  - "[[MiniMax]]"
published:
created: 2026-04-02
...
tags:
  ...
  - pptx
  - xlsx
summary: MiniMax 开源了一套生产级办公文档引擎，包含四个 Office Skills：docx、xlsx、pdf、pptx 生成工具。解决了 Agent 处理文档时"写出来不能用"的问题，确保公式保存后仍为公式、模板编辑后格式不变、数据透视表保存不丢失。
---
