...
description:
category: skills
tags: [skill设计模式, google官方, agent开发, 最佳实践, 工具包装器]
summary: Google 官方总结的 5 种 Skill 设计模式：Tool Wrapper（工具包装器）、Generator（生成器）、Reviewer（审查器）、Inversion（反转模式）、Pipeline（流水线），每种都配有可运行的 ADK 代码。
---
