...
category: skills
tags: [md2pdf, PDF排版, CJK混排, reportlab, 自定义skill]
summary: 作者开发 md2pdf Skill，解决 Markdown 转 PDF 在中文技术报告场景的痛点。核心特性：CJK 字符级精确混排、代码块保真、全链路文档结构（封面/目录/书签/水印）、智能表格列宽、10 种主题风格。纯 Python 零重依赖，一行命令生成出版级 PDF，已在 136 页 Claude Code 深度报告中验证。
