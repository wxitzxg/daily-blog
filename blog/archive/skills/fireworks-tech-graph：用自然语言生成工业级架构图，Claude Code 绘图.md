...
tags:
  ...
  - claude-code-skill
  - 技术可视化
summary: Claude Code 绘图神器，用自然语言生成工业级架构图。支持 5 种视觉风格、8 种图表类型，内置 AI/Agent 领域知识，理解 RAG、Mem0、多 Agent 等模式，输出 SVG + PNG 双格式。支持 Claude Skills 安装，触发词包括"画图"、"生成架构图"等。
---
