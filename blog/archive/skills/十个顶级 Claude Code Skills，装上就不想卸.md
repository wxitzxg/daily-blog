...
published:
created: 2026-03-24
description: "用 Claude Code 大半年了，Skills 和 Plugin 装了几十个，删了一半，留下来的都是真正改变了我工作方式的。这篇就挑十个我用得最多、也觉得最值得推荐的，每个都附安装命令，拿去直接用。"
category: skills
tags: [superpowers, planning-with-files, ui-ux-pro-max, code-review, skills]
summary: 作者分享使用 Claude Code 半年后精选的十个顶级 Skills，包括 Superpowers、Planning with Files、UI UX Pro Max、Code Review、Ralph Loop、MCP Builder、PPTX、Skill Creator 等，每个都附带安装命令和实际使用心得。重点推荐 Superpowers 的 brainstorming 和 TDD 工作流，以及 Planning with Files 解决上下文丢失问题。
原创 Feisky *2026年3月12日 21:24*
