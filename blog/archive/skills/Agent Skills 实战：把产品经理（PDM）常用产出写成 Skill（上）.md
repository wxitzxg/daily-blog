...
source: "https://mp.weixin.qq.com/s/T6rV7Lled86VLZJVPCsKlg"
author:
  - "[[进击的肖恩]]"
published:
created: 2026-04-02
description: "Agent Skills 实战系列。"
category: skills
tags: [agent-skills, 产品经理, 路线图, 优先级, 实战教程]
summary: Agent Skills实战系列上篇，覆盖产品经理常用产出文档类型。五类文档：产品路线图（时间轴、主题、里程碑）、需求优先级/Backlog排序（RICE/MoSCoW框架）、版本规划/发布计划（版本目标、范围、节奏）、竞品分析（对比维度、结论与行动）、产品汇报/周报（进展、风险、决策请求）。包含SKILL.md完整骨架示例、适用边界与常见混淆说明、可选reference.md和scripts结构。与PRD Skill互补：PRD定单次需求，本篇侧重排期、优先级、规划与汇报。
---
